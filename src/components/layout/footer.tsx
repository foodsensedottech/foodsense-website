...
export function Footer({ chrome = null }: FooterProps) {
  ...
  return (
    <footer className="bg-brand-navy text-brand-yellow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            {chrome?.footerTagline ? (
              <p className="text-sm text-brand-yellow/90 max-w-xs">
                {chrome.footerTagline}
              </p>
            ) : null}
            {chrome?.footerGeo ? (
              <p className="text-sm text-brand-yellow/70">{chrome.footerGeo}</p>
            ) : null}
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/"
                  className="hover:text-brand-yellow/80 transition-colors"
                >
                  Home
                </Link>
              </li>
            ...
            <div className="flex flex-col space-y-3">
              {chrome?.footerEmail ? (
                <a
                  ...
                  className="inline-flex items-center gap-2 hover:text-brand-yellow/80 transition-colors"
                >
