...
export const franchiseeCopy = {
    ...
    aboutCards: [
      {
        ...
        body: "Technology programs that have already run at brand scale: POS across the US and Canada, and restaurant-tech leadership for KFC in Latin America and the Caribbean — 20+ countries, 2,200 restaurants, plus cybersecurity and IT infrastructure standards.",
        lucideIcon: "LineChart",
      },
      {
        title: "Vendor Assessment and Restaurant Tech Implementation",
        body: "We work with the major vendors in the restaurant tech space — Oracle, NCR, Deliverect, Orquest, HME, Summit, APEX Food lockers, Eyecatch, Tillster, GRUBBRR, and others — so features, pricing, and support are standardized instead of reinvented store by store.",
        lucideIcon: "ClipboardCheck",
      },
      {
        title: "Project and Program Management",
        body: "Fractional project and program management for POS deployment, KDS optimization, and the other cutovers that cannot stall the line. We own the plan, the vendors, and store-level landing.",
        lucideIcon: "ListChecks",
      },
      {
        title: "Intersection between Technology and Operations",
        body: "Most franchise groups have a gap between the tech team and the operations team. We bring both: how restaurants actually run, and how to implement technology so crews adopt it.",
        lucideIcon: "Users",
      },
    ],
  ...
  es: {
    ...
    aboutIntro:
      "FoodSense es una consultora de tecnología restaurantera construida sobre una década dentro de operadores que sí corren a escala. Ayudamos a armar stacks tempranos de cloud kitchen y delivery en REEF, desplegamos POS en EE.UU. y Canadá con Restaurant Brands International, y lideramos tecnología restaurantera para KFC en Latinoamérica y el Caribe: más de 20 países y 2,200 restaurantes. Conocemos a los vendors. Conocemos a los franquiciatarios. Cerramos la brecha entre tecnología y operaciones.",
    aboutCards: [
      {
        title: "Resultados comprobados",
        body: "Programas de tecnología que ya corrieron a escala de marca: POS en EE.UU. y Canadá, y liderazgo de restaurant tech para KFC en Latinoamérica y el Caribe — más de 20 países, 2,200 restaurantes, además de estándares de ciberseguridad e infraestructura IT.",
        lucideIcon: "LineChart",
      },
      {
        title: "Evaluación de vendors e implementación de tecnología restaurantera",
        body: "Trabajamos con los vendors principales del espacio — Oracle, NCR, Deliverect, Orquest, HME, Summit, APEX Food lockers, Eyecatch, Tillster, GRUBBRR y más — para estandarizar funcionalidad, pricing y soporte en lugar de reinventarlo tienda por tienda.",
        lucideIcon: "ClipboardCheck",
      },
      {
        title: "Gestión de proyectos y programas",
        body: "Project y program management fraccional para despliegue de POS, optimización de KDS y los cortes que no pueden detener la línea. Dueños del plan, de los vendors y del aterrizaje en tienda.",
        lucideIcon: "ListChecks",
      },
      {
        title: "Intersección entre tecnología y operaciones",
        body: "En muchos grupos franquiciatarios hay una brecha clara entre el equipo de tecnología y el de operaciones. Traemos ambos: cómo se opera un restaurante y cómo implementar tecnología para que el equipo la adopte.",
        lucideIcon: "Users",
      },
    ],
