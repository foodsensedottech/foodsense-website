...
export const metadata: Metadata = {
  ...
  description:
    "Fractional tech and ops leadership for 10+ unit QSR. We help growth-stage and franchise operators build, integrate, and scale the stack that runs every shift.",
  openGraph: {
    title: "FoodSense | Fractional Tech & Ops Leadership for QSR",
    description:
      "Fractional tech and ops leadership for 10+ unit QSR — test, prove, scale.",
