...
**Rebuild (wipe / new types):** [`engineering/contentful-rebuild.md`](../engineering/contentful-rebuild.md) — do not full-delete `master` until that runbook’s Phase B/C. Backup first.
